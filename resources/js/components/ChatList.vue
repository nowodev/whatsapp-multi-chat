    ...
    <div class="flex min-h-screen">
        <div class="w-full p-2 mx-auto justify-center flex shadow-xl">
            <div class="min-w-full border rounded grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <a @click="selectChat(c.id._serialized)"
                                ...
                                <div class="w-full pb-2">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="block ml-2 text-sm w-5 text-center font-black text-black bg-green-600 rounded-full">{{
                                                    c.unreadCount
                                            }}</span>
                                    </div>
                ...
                <Messages v-show="!showWelcome" :selected-chat="selectedChat"
                    :received-messages="receivedMessages" :sent-messages="sentMessages"
...
export default {
    ...
    methods: {
        selectChat: function (chatId) {
            ...
            let rM = this.receivedMessages.filter(x => x.from === chatId);
