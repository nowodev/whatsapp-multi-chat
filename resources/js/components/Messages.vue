<template>
    <!-- <div v-show="selectedChat" class="hidden md:col-span-2 lg:col-span-3 md:block">
        <div class="w-full">
            ...
            <div>
                <div class="outline relative w-full p-6 overflow-y-auto h-[40rem]">
                    <ul class="space-y-2">
                        <li v-for="(msg, index) in messages" :key="index" class="flex"
                            ...
                            <div class="relative max-w-xl px-4 py-2 rounded shadow"
                                :class="{ 'text-black': msg.fromMe, 'text-gray-700': !msg.fromMe }">
    ...
    <!-- <div class="md:col-span-2 lg:col-span-3 md:block">
        <div class="grid grid-rows-3 content-between h-full">
            <div class="outline h-3"></div>
            <div class="outline h-3"></div>
            <div class="outline h-3 "></div>
        </div>
    </div> -->
            ...
            <div class="flex flex-1 flex-col">
                ...
                <div class="relative h-full w-full p-6">
                    <div class="inset-0 absolute overflow-y-auto">
                        <ul ref="bottom" class="space-y-2 p-4">
                            <li v-for="(msg, index) in messages" :key="index" class="flex"
                                :class="{ 'justify-end': msg.fromMe, 'justify-start': !msg.fromMe }">
                                <div class="relative max-w-xl px-4 py-2 rounded shadow"
